...
public class ReportDialogSign extends AppCompatDialogFragment {
    private RadioButton rb;
    private RadioGroup rg;
    private ReportDialogSign.ReportDialogListener listener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.layout_dialog_signs, null);
    ...
    public void onAttach(Context context) {
        ...
        try {
            listener = (ReportDialogSign.ReportDialogListener) context;
